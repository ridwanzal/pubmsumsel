...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2019 at 09:58 PM
...
(10, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr6.jpg', '', '', '', ''),
(11, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr7.jpg', '', '', '', ''),
...
(318, '::1', '2019-06-23', 'Chrome', 1, 1561319850);
...
--
ALTER TABLE `visitor`
  MODIFY `visitor_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=319;
