...
(5, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr1.jpg', '', 'Pembangunan dan Realisasi Muara Enim 2019', '', ''),
(6, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr2.jpg', '', 'Menjadikan Muara Enim Kabupaten Terdepan', '', ''),
(7, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr3.jpg', '', 'Pariwisata menjadi Kunci Pengembangan Ekonomi Muara Enim', '', ''),
(8, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr4.jpg', '', 'Terciptanya Lapangan Kerja Baru ', '', ''),
(9, 'http://localhost/pubmsumsel/an-component/media/upload-gambar-pendukung/pupr5.jpg', '', 'Pembangunan Jembatan Kabupaten Muara Enim', '', '');
...
(9, 1, 0, 'syarat-ketentuan', 'Berita', 'http://localhost/pubmsumsel/berita', '_self', 'Y', 15),
(12, 1, 0, 'about-us', 'Unit Dinas', 'http://localhost/pubmsumsel/unit_kerja', '_self', 'Y', 7),
(13, 1, 0, 'privacy', 'Produk Hukum', 'http://localhost/pubmsumsel/produk-hukum', '_self', 'Y', 16),
(14, 1, 0, 'about-us', 'Data Infrastruktur', 'http://localhost/pubmsumsel/data-infrastruktur', '_self', 'Y', 17),
...
(21, 1, 12, '', 'Bidang Pembangunan Jalan Dan Jembatan', 'http://localhost/pubmsumsel/bidang/3899-Bidang-Pembangunan-Jalan-Dan', '_self', 'Y', 9),
(22, 1, 12, '', 'Bidang Preservasi Jalan Dan Jembatan', 'http://localhost/pubmsumsel/bidang/4454-Bidang-Preservasi-Jalan-Dan', '_self', 'Y', 10),
(23, 1, 0, 'faq', 'Galeri', 'http://localhost/pubmsumsel/galeri', '_self', 'Y', 18),
(24, 1, 0, 'faq', 'Kontak', 'http://localhost/pubmsumsel/kontak', '_self', 'Y', 19),
(27, 1, 12, '', 'Bidang Tata Bangunan dan Jasa Konstruksi', 'http://localhost/pubmsumsel/bidang/3187-Bidang-Tata-Bangunan-dan-Jas', '_self', 'Y', 11),
(28, 1, 12, '', 'Bidang Air Minum dan Penyehatan Lingkungan Permukiman', 'http://localhost/pubmsumsel/bidang/2750-Bidang-Air-Minum-dan-Penyehatan-Lingkungan', '_self', 'Y', 12),
(29, 1, 12, '', 'Bidang Sumber Daya Air', 'http://localhost/pubmsumsel/bidang/7549-Bidang-Sumber-Daya-Air', '_self', 'Y', 13),
(30, 1, 12, '', 'Bidang Tata Ruang', 'http://localhost/pubmsumsel/bidang/7822-Bidang-Tata', '_self', 'Y', 14),
(31, 1, 12, '', 'Sekretariat', 'http://localhost/pubmsumsel/bidang/2783-', '_self', 'Y', 8),
(32, 1, 0, 'faq', 'FAQ', 'http://localhost/pubmsumsel/faq', '_self', 'N', 20);
