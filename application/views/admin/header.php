...
<head>
  ...
  <!-- Font Awesome Icons -->
  <link href="<?php path_adm() ?>/plugins/font-awesome-4.3.0/css/font-awesome.min.css" rel="stylesheet"
    type="text/css" />
  ...
  <!-- DATATABLES -->
  <link href="<?php path_adm() ?>/plugins/datatables/media/css/dataTables.bootstrap.css" rel="stylesheet"
    type="text/css" />

  <link href="<?php path_adm() ?>/plugins/datatables/extensions/Responsive/css/responsive.dataTables.css"
    rel="stylesheet" type="text/css" />
  <!-- DATATABLES -->


  <link href="<?php path_adm() ?>/datepicker/css/bootstrap-datepicker3.standalone.min.css" rel="stylesheet"
    type="text/css" />
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <?php if($user_level=='2'){ ?>
          <li class='<?php if($npage==30){ echo'active';} ?>'><a href="<?php echo $burl; ?>/pengujian"><i
                class='fa fa-flask'></i> <span>Pengujian</span></a> </li>
          <?php } else if($user_level=='1') { ?>


          <li class="header">Navigasi</li>
          <li class='<?php if($npage==1){ echo'active';} ?>'><a href="<?php echo $burl; ?>"><i
                class='fa fa-dashboard'></i> <span>Halaman Utama</span></a> </li>

          <li class='treeview  <?php if(($npage==6) OR( $npage==7)){ echo'active';} ?>'>
            <a href='#'><i class='fa fa-pencil-square'></i><span>Artikel</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class='<?php if($npage==7){ echo'active';} ?>'><a href='<?php echo $burl; ?>/all_artikel'><i
                    class='fa fa-circle-o'></i><span>Semua Artikel</span></a></li>
              <li class='<?php if($npage==6){ echo'active';} ?>'><a href='<?php echo $burl; ?>/artikel'><i
                    class='fa fa-circle-o'></i><span>Artikel Baru</span></a></li>
            </ul>
          </li>

          <li class='treeview <?php if($npage=='14' OR $npage=='15') { echo "active"; } ?>'>
            <a href='#'><i class='fa fa-camera'></i><span>Galeri Foto</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class="<?php if($npage==15){ echo "active";} ?>"><a href='<?php echo $burl ?>/all_galeri'><i
                    class='fa fa-circle-o'></i><span>Tampilkan Galeri</span></a></li>
              <li class="<?php if($npage==14){ echo "active";} ?>"><a href='<?php echo $burl; ?>/galeri'><i
                    class='fa fa-circle-o'></i><span>Buat Galeri</span></a></li>
            </ul>
          </li>
          ...
          <li class='treeview <?php if($npage==12 || $npage==13){ echo'active';} ?>'>
            ...
            <ul class='treeview-menu'>
              <li class="<?php if($npage==13){ echo'active';} ?>"><a href="<?php echo $burl; ?>/all_page"><i
                    class='fa fa-circle-o'></i><span>Semua Page</span></a></li>
              <li class="<?php if($npage==12){ echo'active';} ?>"><a href="<?php echo $burl; ?>/page"><i
                    class='fa fa-circle-o'></i><span>Buat Page</span></a></li>
            </ul>
          </li>


          <li class='treeview <?php if($npage==105 || $npage==106){ echo'active';} ?>'>
            <a href='#'><i class='fa fa-asterisk'></i><span>Struktur Organisasi</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class="<?php if($npage==106){ echo'active';} ?>"><a href="<?php echo $burl; ?>/bidang_jabatan"><i
                    class='fa fa-circle-o'></i><span>Jabatan</span></a></li>
              <li class="<?php if($npage==105){ echo'active';} ?>"><a href="<?php echo $burl; ?>/struktur_organisasi"><i
                    class='fa fa-circle-o'></i><span>Data Pegawai</span></a></li>
            </ul>
          </li>
          ...
          <li class='<?php if($npage==131){ echo'active';} ?>'><a
              href="<?php echo base_url('admin/data_infastruktur'); ?>"><i class='fa fa-road'></i><span>Data
                Infrastruktur</span></a></li>
          <li class='<?php if($npage==133){ echo'active';} ?>'><a
              href="<?php echo base_url('admin/produk_hukum'); ?>"><i class='fa fa-gavel'></i><span>Produk
                Hukum</span></a></li>

          <li class='treeview <?php if($npage==99 || $npage=='allbidang'){ echo'active';} ?>'>
            <a href='#'><i class='fa fa-file-text'></i><span>Bidang</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class="<?php if($npage=='allbidang'){ echo'active';} ?>"><a href="<?php echo $burl; ?>/all_bidang"><i
                    class='fa fa-circle-o'></i><span>Semua Bidang</span></a></li>
              <li class="<?php if($npage==99){ echo'active';} ?>"><a href="<?php echo $burl; ?>/bidang"><i
                    class='fa fa-circle-o'></i><span>Buat Bidang</span></a></li>
            </ul>
          </li>

          <li class='treeview <?php if($npage==9){ echo'active';} ?>'><a href="#"><i
                class='fa  fa-image'></i><span>Media</span><i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li class='<?php if($npage==9){ echo'active';} ?>'><a href="<?php echo $burl; ?>/media"><i
                    class='fa fa-circle-o'></i><span>Semua</span></a></li>
              <li class='pop-up-upload'><a href='#'><i class='fa fa-circle-o'></i><span>Pup Up Upload</span></a></li>
            </ul>
          </li>
          <li class='<?php if($npage==23){ echo'active';} ?>'><a href="<?php echo $burl; ?>/kontak_masuk"><i
                class='fa fa-paper-plane-o'></i> <span>Kotak Masuk</span></a> </li>
          ...
          <li class='treeview <?php if($npage==2 || $npage==18 || $npage==19){ echo'active';} ?>'>
            <a href="#"><i class='fa fa-navicon'></i> <span>Kategori</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class='treeview <?php if($npage==2){ echo'active';} ?>'><a href='<?php echo $burl; ?>/kategori'><i
                    class='fa fa-circle-o'></i><span>Artikel</span></a></li>
              <li class='treeview <?php if($npage==18){ echo'active';} ?>'><a
                  href='<?php echo $burl; ?>/kategori_galeri'><i class='fa fa-circle-o'></i><span>Galeri</span></a></li>
              <li class='treeview <?php if($npage==19){ echo'active';} ?>'><a
                  href='<?php echo $burl; ?>/kategori_produk'><i class='fa fa-circle-o'></i><span>Produk</span></a></li>
            </ul>
          </li>
          ...
          <li class='treeview <?php if(($npage==3) OR( $npage==4) OR ($npage==5)){ echo'active';} ?>'>
            ...
            <ul class='treeview-menu'>
              <?php //if($user_level=='1'){
                  ?>
              <li class='<?php if($npage==4){ echo'active';} ?>'><a href='<?php echo $burl; ?>/all_user'><i
                    class='fa fa-circle-o'></i><span>Managemen User</span></a></li>
              <li class='<?php if($npage==3){ echo'active';} ?>'><a href='<?php echo $burl; ?>/user_baru'><i
                    class='fa fa-circle-o'></i><span>User Baru</span></a></li>
              <?php //}
                ?>
              <li class='<?php if($npage==5){ echo'active';} ?>'><a href='<?php echo $burl; ?>/profil_user'><i
                    class='fa fa-circle-o'></i><span>Profil</span></a></li>
            </ul>
          </li>

          <li class='treeview <?php if($npage==10 OR $npage==11 OR $npage==20 OR $npage==22){ echo'active';} ?>'>
            <a href="#"><i class='fa fa-toggle-on'></i><span>Pengaturan Web</span><i
                class="fa fa-angle-left pull-right"></i></a>
            <ul class='treeview-menu'>
              <li class='<?php if($npage==10){ echo'active';} ?>'><a href='<?php echo $burl; ?>/informasi'><i
                    class='fa fa-circle-o'></i><span>Informasi Web</span></a></li>
              <li class='<?php if($npage==11){ echo'active';} ?>'><a href='<?php echo $burl; ?>/biodata'><i
                    class='fa fa-circle-o'></i><span>Biodata</span></a></li>

              <li class='<?php if($npage==22){ echo'active';} ?>'><a href='<?php echo $burl; ?>/pihak_ketiga'><i
                    class='fa fa-circle-o'></i><span>Pihak ketiga</span></a></li>

              <li class='<?php if($npage==20){ echo'active';} ?>'><a href='<?php echo $burl; ?>/banner_depan'><i
                    class='fa fa-circle-o'></i><span>Banner Depan</span></a></li>
            </ul>
          </li>
          <?php } ?>
