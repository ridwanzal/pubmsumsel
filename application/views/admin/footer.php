...
<?php  if($npage==301){ ?>
  <script type="text/javascript">
    function set_modal(nama,judul,isi,tipe,gambar,waktu,status,latitude,longitude,id){
      $('#status').removeClass('label-success');
      $('#status').removeClass('label-danger');
      $('#status').removeClass('label-warning');
      $('#tipe').removeClass('label-success');
      $('#tipe').removeClass('label-danger');
      $('#tipe').removeClass('label-warning');
      $('#nama').text(nama);
      $('#judul').text(judul);
      $('#isi').html(isi);
      $('#tipe').text(tipe);
      if (tipe == 'Terbuka') {
        $('#tipe').addClass('label-success');
      } else if(tipe == 'Rahasia') {
        $('#tipe').addClass('label-danger');
      } else {
        $('#tipe').addClass('label-warning');
      }
