...
?>
    <div id='footer' style="background : url('http://pubmtrsumsel.scafol.id/an-theme/ando/assets/img/musi.png'); background-size:cover; color: #888; padding-top: 120px; padding-bottom: 120px;">
        <div class='container'>
            <div class="row">
                <div class="col-md-3">
